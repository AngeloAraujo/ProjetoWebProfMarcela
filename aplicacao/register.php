...
require_once "../config/conf.inc2.php";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["username"]))) {
        ...
        $sql = " SELECT idlogin FROM transporte.login WHERE usuario = :username";
    ...
    if (empty($username_err) && empty($senha_err) && empty($confirm_senha_err)) {
        ...
        $sql = "INSERT INTO transporte.login (usuario, senha) VALUES (:username, :senha)";
